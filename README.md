...
固件、协议文档和桌面端应用。请查看 [README_CN.md](README_CN.md) 以获取详细信息。

## Other links

ROS package:  [https://github.com/oymotion/rohand_gen2_ros_pkg](https://github.com/oymotion/rohand_ros_pkg)

ROS2 package:  [https://github.com/oymotion/rohand_gen2_ros2_pkg](https://github.com/oymotion/rohand_ros2_pkg)

ROS URDF package: [https://github.com/oymotion/rohand_gen2_urdf_ros1](https://github.com/oymotion/rohand_gen2_urdf_ros1)
